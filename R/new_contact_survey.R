...
#' @description Deprecated. A `survey` object contains the results of a
#'   contact survey. In particular, it contains two data frames called
#'   `participants` and `contacts` that are linked by a column specified as
#'   `id.column`.
